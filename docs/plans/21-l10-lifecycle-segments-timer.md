# 21: L10: lifecycle, segments & timer

**What to build:** The meeting shell: start this week's Level 10 (open meetings deletable), the fixed 7-segment agenda with per-segment countdown and total elapsed time, advisory facilitator label, anyone can advance segments, and the meeting pre-loads the previous week's scorecard, current rock statuses, and last week's to-dos.
