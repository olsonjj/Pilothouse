# 25: L10: conclude, ratings & archive

**What to build:** Ending the meeting the EOS way: recap of new to-dos, cascading messages, per-participant 1–10 rating; on conclude, unsolved issues return to the long-term list and the meeting freezes into an immutable archive with rating trends over time.
