# 13: Scorecard: metric definitions

**What to build:** The team's weekly metrics: define 5–15 metrics with owner, weekly target, comparison direction (higher/lower is better), display unit, and an active flag for retirement.
