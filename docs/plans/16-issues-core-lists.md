# 16: Issues: core lists

**What to build:** The team's Issues Lists: one-line issues classified long-term (quarter) or short-term (week), with aging display, resolution notes, and derived status (open until resolved). The provenance plumbing comes later; this is the list itself.
