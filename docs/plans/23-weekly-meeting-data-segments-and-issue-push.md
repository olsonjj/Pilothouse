# 23: L10: data segments & issue push

**What to build:** The five-minute discipline: the Scorecard, Rocks, and To-Do segments render their data with pass/fail flags, and any red cell, off-track rock, or missed to-do can be pushed into the meeting's issue list with one click — provenance recorded.
